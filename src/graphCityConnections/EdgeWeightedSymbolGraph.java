 ...
 *  reads data from a csv file that lists the two cities in the first two
 *  column and the weight in the third column.
...
public class EdgeWeightedSymbolGraph {
    ...
    public EdgeWeightedSymbolGraph(String filename, String delimiter) {
        ...
        while (in.hasNextLine()) {
            String[] a = in.readLine().split(delimiter);
            int v = st.get(a[0]); //county
            int w = st.get(a[1]); //city
