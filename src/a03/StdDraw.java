...
*/
     ...
     */
    public static void main(String[] args) {
        //Draw a thick red square...
        StdDraw.setPenRadius(0.02);
        StdDraw.setPenColor(StdDraw.BOOK_RED);
        StdDraw.square(0.2, 0.8, 0.1);

        //Draw a blue diamond around the red square...
        ...
        //Draw a filled orange square...
        StdDraw.setPenRadius();
        StdDraw.setPenColor(ORANGE);
        StdDraw.filledSquare(0.8, 0.8, 0.2);

        //Draw a smaller black square in the orange square
        StdDraw.setPenRadius();
        StdDraw.setPenColor();
        StdDraw.square(0.8, 0.8, 0.15);

        //Draw a thin black circle...
        StdDraw.setPenRadius();
        StdDraw.setPenColor();
        StdDraw.circle(0.8, 0.2, 0.2);

        //Draw a red arc, but mirrored from original...
        StdDraw.setPenColor(StdDraw.BOOK_RED);
        StdDraw.setPenRadius(0.02);
        StdDraw.arc(0.8, 0.2, 0.1, 45, 200);

        //Draw a gray circle inside of the red arc...
        StdDraw.setPenRadius();
